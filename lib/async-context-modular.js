...
(function (Cancellables) {
    ...
    class AsyncContext {
        constructor(callback, options) {
            ...
            this._feeder = new AsyncFeed((resolve, reject, controller) => {
    ...
    Cancellables.AsyncContext = AsyncContext;
    ...
    class AsyncFeed extends Cancellable {
        cancel() {
            return this[Cancellables.cancelSymbol]();
        }
    }
    Cancellables.AsyncFeed = AsyncFeed;
